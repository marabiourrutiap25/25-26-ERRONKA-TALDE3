...
require_once __DIR__ . '/../service/KategoriaService.php';

$dbObj = new DB();
$conn = $dbObj->konektatu();
$service = new KategoriaService($conn);
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $action === 'getAll') {
    ...
    $resultado = $service->getAllKategoriak($api_key);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'create') {
    ...
    $resultado = $service->createKategoria($api_key, $data);
    echo json_encode($resultado);
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'update') {
    ...
    $resultado = $service->updateKategoria($api_key, $id, $data);
    echo json_encode($resultado);
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE' && $action === 'delete') {
    ...
    $resultado = $service->deleteKategoria($api_key, $id);
    echo json_encode($resultado);
    exit;
}
